...
public class Irpf {
    ...
    public double getRendimentoTotal () {
        double finalValue = new CalculateRendimento(this).computarValorTotal(this.rendimentos, 0);
    ...
    public double getDeducaoTotal() {
        ...
        double finalValue = new CalculateDeducao(this).computarValorTotal(this.deducoes, dependenteFinalValue);
        return this.truncateValue(finalValue);
    }
    ...
    public void addRendimento(Rendimento rendimento) throws DescricaoEmBrancoException, ValorRendimentoInvalidoException {
